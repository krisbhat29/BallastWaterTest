...
//!                All Rights Reserved
//!
//! @brief         Implementation of the algorithm for 3-phase pumps
//! 
//! @detail        This module defines the methods used to drive 3 phase pumps
//! 
//! @date          15-May-2015 
//! @author        Krishna Bhat
//! 
...
#define PUMPC_PIN1            8
#define PUMPC_PIN2            9
#define PUMPC_PIN3            10
#define PUMPD_PIN1            11
#define PUMPD_PIN2            12
#define PUMPD_PIN3            13
...
void loop() 
{
  ...
  {*/
    ...
    digitalWrite(PUMPA_PIN1,HIGH);        // Open inlet valve
    digitalWrite(PUMPB_PIN1,HIGH);
    digitalWrite(PUMPC_PIN1,HIGH);
    digitalWrite(PUMPD_PIN1,HIGH);
    delay(delayVal);
    digitalWrite(PUMPA_PIN2,HIGH);        // Pull pump cylinder
    digitalWrite(PUMPB_PIN2,HIGH);
    digitalWrite(PUMPC_PIN2,HIGH);
    digitalWrite(PUMPD_PIN2,HIGH);
    delay(delayVal);
    digitalWrite(PUMPA_PIN1,LOW);         // Close inlet valve
    digitalWrite(PUMPB_PIN1,LOW);
    digitalWrite(PUMPC_PIN1,LOW);
    digitalWrite(PUMPD_PIN1,LOW);
    delay(delayVal);
    digitalWrite(PUMPA_PIN3,HIGH);        // Open outlet valve
    digitalWrite(PUMPB_PIN3,HIGH);
    digitalWrite(PUMPC_PIN3,HIGH);
    digitalWrite(PUMPD_PIN3,HIGH);
    delay(delayVal);    
    digitalWrite(PUMPA_PIN2,LOW);         // Push pump cylinder
    digitalWrite(PUMPB_PIN2,LOW);
    digitalWrite(PUMPC_PIN2,LOW);
    digitalWrite(PUMPD_PIN2,LOW);
    delay(delayVal);
    digitalWrite(PUMPA_PIN3,LOW);         // Close outlet valve
    digitalWrite(PUMPB_PIN3,LOW);
    digitalWrite(PUMPC_PIN3,LOW);
    digitalWrite(PUMPD_PIN3,LOW);    
   // delay(delayVal);
      ...
      case DISPDATA:
        {
          ...
          Serial.println("T/6 state duration    : " + String(delayVal) + "ms\n");          
          /*
